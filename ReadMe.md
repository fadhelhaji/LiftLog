## Screenshot/Logo:
<img src = "Screenshots\App-screenshot.png" alt= "LiftLog-landing-page-screenshot">
...
## Getting Started
- Deployed App Link: https://www.liftlog.live/
...
## Next Steps
- Add social features, such as sharing workouts or progress with people.
- Create a mobile-friendly responsive design to improve usability on all devices, and allow push notifications.
- Add analytics dashboard with charts and graphs.
- Implement data export so users can download their workout/nutrition history.
- Enhance the app’s visual design with improved layouts, colors, fonts, and overall user experience.
